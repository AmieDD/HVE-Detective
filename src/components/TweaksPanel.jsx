...
const __TWEAKS_STYLE = `
  ...
  .twk-fab{position:fixed;right:16px;bottom:16px;z-index:2147483646;width:36px;height:36px;border-radius:50%;background:rgba(250,249,247,.78);border:.5px solid rgba(0,0,0,.1);box-shadow:0 2px 8px rgba(0,0,0,.15);font-size:18px;cursor:pointer;display:grid;place-items:center;-webkit-backdrop-filter:blur(12px);backdrop-filter:blur(12px)}
`;
